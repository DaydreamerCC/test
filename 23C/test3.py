...
# 4. 训练XGBoost模型
# model = XGBRegressor(n_estimators=897, learning_rate=0.054, max_depth=6, random_state=42)
model = XGBRegressor(n_estimators=630, learning_rate=0.0833, max_depth=5, random_state=42)
