...
result1_1_path = os.path.join(path, 'result1_1.xlsx')
result1_1_2024 = pd.read_excel(result1_1_path, sheet_name=0)

result1_1_2024 = result1_1_2024.drop(range(0, 54)).reset_index()

print(result1_1_2024)

for i in range(1, 42):
    for j in range(1, 29):
        result1_1_2024[countryside_planting_crops['作物名称'][i - 1]][j - 1] = x[(i, j+26, 2, 7)].varValue

result1_1_2024.to_excel('result1_1_2024.xlsx')
